...
namespace Mycom.Target.Unity.Editor
{
    ...
    public sealed class MyTargetAndroidPostProcessor : IPostGenerateGradleAndroidProject
    {
        ...
        public void OnPostGenerateGradleAndroidProject(string path)
        {
            ...
            {
                newProperties.AddRange(File.ReadAllLines(gradlePropertiesPath).Where(line => !line.Contains("android.enableDexingArtifactTransform")));
            }

            newProperties.Add("android.enableDexingArtifactTransform=false");
